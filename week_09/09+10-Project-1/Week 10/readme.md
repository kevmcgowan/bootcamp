...
For this week, you'll finish your project and give a presentation on it in class.

## Heads-Up

* In the next module, you will begin to use Node.js. Be sure to have it installed on your computer **before** starting the next module and attending your classes. Follow the [Node.js installation guide on The Full-Stack Blog](https://coding-boot-camp.github.io/full-stack/nodejs/how-to-install-nodejs) to install Node.js on your computer.
